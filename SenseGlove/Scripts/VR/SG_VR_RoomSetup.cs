...
namespace SG.VR
{
    /// <summary> VR Room setup to recenter our user. Can be linked directly to a SG_VR_Rig, or to a SG_VR_Setup script whcih chooses the right VR Rig for you. </summary>
    public class SG_VR_RoomSetup : MonoBehaviour
	{
        //--------------------------------------------------------------------------------------------------------------------------
        // Member Variables
        ...
        /// <summary> Notify this RoomSetup that we've found a VR Rig. Called if we're linked to a SG_VR_Setup that has detected a headset. </summary>
        /// <param name="headset"></param>
        public void VRHeadsetFound(SG_VR_Rig headset)
        {
