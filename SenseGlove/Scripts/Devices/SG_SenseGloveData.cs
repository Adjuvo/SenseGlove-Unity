...
namespace SG
{
    ...
    public class SG_SenseGloveData
    {
        //-------------------------------------------------------------------------------------------------------------------
        // General Variables
        ...
        /// <summary> Create an instance of SG_SenseGloveData with default values. </summary>
        protected SG_SenseGloveData()
        {
            SetEmpty();
        ...
        public static SG_SenseGloveData Empty { get { return new SG_SenseGloveData(); } }
        ...
        public SG_SenseGloveData(SenseGloveCs.GloveData data)
        {
            if (data != null)
            {
                this.gloveSide = SG_SenseGloveData.GetSide(data.kinematics.isRight);
        ...
        public void UpdateVariables(SenseGloveCs.GloveData data)
        {
            ...
            SG_SenseGloveData.GetChainVariables(ref data.kinematics.gloveLinks, ref this.glovePositions,
                    ref this.gloveAngles, ref this.gloveRotations, ref this.gloveLengths);

            SG_SenseGloveData.GetChainVariables(ref data.kinematics.fingers, ref this.handPositions,
        ...
        public void SetEmpty()
        {
            ...
            this.gloveValues = new float[5][] { new float[] { }, new float[] { }, new float[] { }, new float[] { }, new float[] { } };
        ...
        public float[] GetFlexions()
        {
            float[] res = new float[5];
            Vector3[] totalAngles = this.TotalGloveAngles();
            for (int f = 0; f < totalAngles.Length && f < res.Length; f++)
            {
                res[f] = totalAngles[f].z;
            }
            return res;
        }
        ...
        protected static void GetChainVariables(ref SenseGloveCs.Kinematics.JointChain[] chains, ref Vector3[][] positions, ref Vector3[][] angles, ref Quaternion[][] rotations, ref Vector3[][] lengths)
        {
            ...
            for (int f = 0; f < N; f++)
            {
                SG_SenseGloveData.GetLinkVariables(ref chains[f], ref positions[f], ref angles[f], ref rotations[f], ref lengths[f]);
            }
        }
