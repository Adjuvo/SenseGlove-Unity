...
namespace SG
{
    ...
    public class SG_Breakable : MonoBehaviour
    {
        ...
        public SG_Interactable brokenObject;
        ...
        public UnbreakType unbreakMethod = UnbreakType.None;
        ...
        {
            return wholeMaterial != null && wholeMaterial.IsBroken();
        }
        ...
        {
            if (this.unbreakMethod != UnbreakType.None && this.IsBroken())
            {
                ...
                {
                    if (this.unbreakMethod == UnbreakType.Reset)
                        this.ResetObject();
                    else if (this.unbreakMethod == UnbreakType.Unbreak)
                        this.UnBreak();
